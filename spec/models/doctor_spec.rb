...
RSpec.describe Doctor do
  ...
  describe 'instance methods' do 
    ...
    it 'returns the number of patients for a doctor' do 

      expect(@doctor_1.patient_count).to eq(5)
      expect(@doctor_2.patient_count).to eq(6)
      expect(@doctor_3.patient_count).to eq(7)
    end
  end
end
